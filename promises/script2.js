...
// 3. The callback function has 2 arguments named 'resolve' and 'reject'. Resolve and reject are the 
//    keywords provided by JS.
...
// 11. If it returns a value => It will be  used as a parameter in next function. If it is a promise then 
//     the next .then in the promise chain is attached to the promise returned by the current callback function.
